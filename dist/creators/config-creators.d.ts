...
export declare function createDrizzleConfig(projectPath: string): Promise<void>;
export declare function createEnvironmentFiles(projectPath: string): Promise<void>;
//# sourceMappingURL=config-creators.d.ts.map